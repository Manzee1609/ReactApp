...
import i1 from './assets/img/about.jpg';
      ...
      <div className="container">
        ...
        <div className="row menu-container">
          ...
          <div className="col-lg-6 menu-item filter-starters">
            <img src={require("./assets/img/menu/lobster-bisque.jpg")} className="menu-img" alt=""/>
          ...
          <div className="col-lg-6 menu-item filter-specialty">
            <img src={require("./assets/img/menu/bread-barrel.jpg")} className="menu-img" alt=""/>
            <div className="menu-content">
          ...
          <div className="col-lg-6 menu-item filter-starters">
            <img src={require("./assets/img/menu/cake.jpg")} className="menu-img" alt=""/>
            <div className="menu-content">
          ...
          <div className="col-lg-6 menu-item filter-salads">
            <img src={require("./assets/img/menu/caesar.jpg")} className="menu-img" alt=""/>
            <div className="menu-content">
          ...
          <div className="col-lg-6 menu-item filter-specialty">
            <img src={require("./assets/img/menu/tuscan-grilled.jpg")} className="menu-img" alt=""/>
            <div className="menu-content">
          ...
          <div className="col-lg-6 menu-item filter-starters">
            <img src={require("./assets/img/menu/mozzarella.jpg")} className="menu-img" alt=""/>
            <div className="menu-content">
          ...
          <div className="col-lg-6 menu-item filter-salads">
            <img src={require("./assets/img/menu/greek-salad.jpg")} className="menu-img" alt=""/>
            <div className="menu-content">
          ...
          <div className="col-lg-6 menu-item filter-salads">
            <img src={require("./assets/img/menu/spinach-salad.jpg")} className="menu-img" alt=""/>
            <div className="menu-content">
          ...
          <div className="col-lg-6 menu-item filter-specialty">
            <img src={require("./assets/img/menu/lobster-roll.jpg")} className="menu-img" alt=""/>
            <div className="menu-content">
          ...
          <div className="col-lg-3">
            <ul className="nav nav-tabs flex-column">
              <li className="nav-item">
                <a className="nav-link active show" href="#tab-1">Modi sit est</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="#tab-2">Unde praesentium sed</a>
              </li>
              <li className="nav-item">
                <a className="nav-link"  href="#tab-3">Pariatur explicabo vel</a>
              </li>
              <li className="nav-item">
                <a className="nav-link"  href="#tab-4">Nostrum qui quasi</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="#tab-5">Iusto ut expedita aut</a>
              </li>
            </ul>
          </div>
            ...
            <div className="tab-content">
              <div className="tab-pane active show" id="tab-1">
                <div className="row">
                  ...
                  <div className="col-lg-4 text-center order-1 order-lg-2">
                    <img src={require("./assets/img/specials-1.png")} alt="" className="img-fluid"/>
                  </div>
                </div>
              </div>
              <div className="tab-pane" id="tab-2">
                <div className="row">
                  ...
                  <div className="col-lg-4 text-center order-1 order-lg-2">
                    <img src={require("./assets/img/specials-2.png")} alt="" className="img-fluid"/>
                  </div>
                </div>
              </div>
              <div className="tab-pane" id="tab-3">
                <div className="row">
                  ...
                  <div className="col-lg-4 text-center order-1 order-lg-2">
                    <img src={require("./assets/img/specials-3.png")} alt="" className="img-fluid"/>
                  </div>
                </div>
              </div>
              <div className="tab-pane" id="tab-4">
                <div className="row">
                  ...
                  <div className="col-lg-4 text-center order-1 order-lg-2">
                    <img src={require("./assets/img/specials-4.png")} alt="" className="img-fluid"/>
                  </div>
                </div>
              </div>
              <div className="tab-pane" id="tab-5">
                <div className="row">
                  ...
                  <div className="col-lg-4 text-center order-1 order-lg-2">
                    <img src={require("./assets/img/specials-5.png")} alt="" className="img-fluid"/>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="events-slider swiper">
          <div className="swiper-wrapper">
            ...
            <div className="swiper-slide">
              <div className="row event-item">
                <div className="col-lg-6">
                  <img src={require("./assets/img/event-private.jpg")} className="img-fluid" alt=""/>
                </div>
                <div className="col-lg-6 pt-4 pt-lg-0 content">
            ...
            <div className="swiper-slide">
              <div className="row event-item">
                <div className="col-lg-6">
                  <img src={require("./assets/img/event-custom.jpg")} className="img-fluid" alt=""/>
                </div>
                <div className="col-lg-6 pt-4 pt-lg-0 content">
        ...
        <div className="row">
          ...
          <div className="col-lg-4 col-md-6">
            <div className="member">
              <img src={require("./assets/img/chefs/chefs-1.jpg")} className="img-fluid" alt=""/>
          ...
          <div className="col-lg-4 col-md-6">
            <div className="member">
              <img src={require("./assets/img/chefs/chefs-2.jpg")} className="img-fluid" alt=""/>
              <div className="member-info">
                <div className="member-info-content">
                  <h4>Sarah Jhonson</h4>
                  <span>Patissier</span>
          ...
          <div className="col-lg-4 col-md-6">
            <div className="member">
              <img src={require("./assets/img/chefs/chefs-3.jpg")} className="img-fluid" alt=""/>
              <div className="member-info">
                <div className="member-info-content">
